...
function func0(a: number): number {
    return a * 2;
}
...
function func4(a: number | string): void {
...
*/
function q2(a: number | string): number {
...
*/
function q3(a: number, b: boolean, c: string): string | void {
    let result = 0;
    result += a;
    if (b) {
        result += 500;
